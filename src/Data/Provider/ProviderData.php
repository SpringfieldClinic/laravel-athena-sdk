...
readonly class ProviderData extends AthenaData
{
    ...
    public static function fromArray(array $data): static
    {
        return new self(
            ...
            hideInPortal: self::toBool($data['hideinportal'] ?? null),
            billable: self::toBool($data['billable'] ?? null),
            createsEncounters: self::toBool($data['createencounteroncheckin'] ?? null),
